...
def _solveToHorizon(
    s, t, r, q, strikes, timeIndex, volatilityGrid, volTypeValue, xinits, finSolverType
):
...
@njit(
    float64(
        float64, float64, float64, float64, int64, int64, float64, float64, float64[:]
    ),
    fastmath=True,
)
...
class FinEquityVolSurface:
    ...
    def volatilityFromDeltaDate(self, callDelta, expiryDate, deltaMethod=None):
        ...
        vol0 = volFunction(volTypeValue, self._parameters[index0], fwd0, K0, t0)
        ...
        if index1 != index0:
            ...
            vol1 = volFunction(volTypeValue, self._parameters[index1], fwd1, K1, t1)
        else:
            vol1 = vol0
        ...
        for i in range(0, self._numExpiryDates):
            ...
            for j in range(0, self._numStrikes):
                ...
                print(
                    ...
                    % (expiryDate, strike, fittedVol * 100.0, mktVol * 100, diff * 100)
                )
    ...
    def plotVolCurves(self):
        ...
        for tenorIndex in range(0, self._numExpiryDates):
            ...
            for i in range(0, numIntervals):
                ...
                ks.append(K)
                fittedVol = self.volatilityFromStrikeDate(K, expiryDate) * 100.0
