...
class FinInterpolator:
    def __init__(self, interpolatorType: FinInterpTypes):
    ...
    def fit(self, times: np.ndarray, dfs: np.ndarray):
        ...
        #                                  bc_type=((2, 0.0), (1, 0.0)))
            ...
            self._interpFn = CubicSpline(
                self._times, zeroRates, bc_type=((2, 0.0), (1, 0.0))
            )
            ...
            logDfs = np.log(self._dfs)
            self._interpFn = CubicSpline(self._times, logDfs, bc_type="natural")
            ...
            self._interpFn = CubicSpline(self._times, zeroRates, bc_type="natural")
    ...
    def interpolate(self, t: float):
        ...
        #            out = np.exp(self._interpFn(tvec))
            ...
            out = _vinterpolate(tvec, self._times, self._dfs, self._interpType.value)
