...
class FinFXFixedLookbackOption:
    ...
    def __init__(
        self, expiryDate: FinDate, optionType: FinOptionTypes, optionStrike: float
    ):
    ...
    def value(
        ...
        if self._optionType == FinOptionTypes.EUROPEAN_CALL:
            ...
            raise FinError("Unknown lookback option type:" + str(self._optionType))
    ...
    def valueMC(
        ...
        model = FinGBMProcess()
        Sall = model.getPaths(numPaths, numTimeSteps, t, mu, S0, volatility, seed)
