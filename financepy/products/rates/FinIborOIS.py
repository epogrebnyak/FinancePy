...
class FinIborOIS(object):
    ...
    def __init__(
        ...
        self._floatIborLeg = FinFloatLeg(
            effectiveDate,
    ...
    def value(
        ...
        floatIborLegValue = self._floatIborLeg.value(
            valuationDate, discountCurve, indexIborCurve, firstFixingRateLeg1
        )

        floatOISLegValue = self._floatOISLeg.value(
            valuationDate, discountCurve, indexOISCurve, firstFixingRateLeg2
        )
