...
class FinIborSwap(object):
    ...
    def value(
        ...
        fixedLegValue = self._fixedLeg.value(valuationDate, discountCurve)

        floatLegValue = self._floatLeg.value(
            valuationDate, discountCurve, indexCurve, firstFixingRate
        )
    ...
    def swapRate(
        ...
        if indexCurve is None:
            ...
            floatLegPV = self._floatLeg.value(
    ...
    def cashSettledPV01(self, valuationDate, flatSwapRate, frequencyType):
