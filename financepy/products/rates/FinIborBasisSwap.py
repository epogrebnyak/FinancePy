...
class FinIborBasisSwap(object):
    ...
    def value(
        ...
        floatLeg1Value = self._floatLeg1.value(
            valuationDate, discountCurve, indexCurveLeg1, firstFixingRateLeg1
        )

        floatLeg2Value = self._floatLeg2.value(
            valuationDate, discountCurve, indexCurveLeg2, firstFixingRateLeg2
        )
