...
class FinOIS(object):
    ...
    def value(
        self, valuationDate: FinDate, oisCurve: FinDiscountCurve, firstFixingRate=None
    ):
        """Value the interest rate swap on a value date given a single Ibor
        discount curve."""

        fixedLegValue = self._fixedLeg.value(valuationDate, oisCurve)

        floatLegValue = self._floatLeg.value(
            valuationDate, oisCurve, oisCurve, firstFixingRate
        )
