...
class FinInflationBond(FinBond):
    ...
    ):  # Value of CPI index at bond issue date
    ...
    def flatPriceFromYieldToMaturity(
        self,
        settlementDate: FinDate,
        ytm: float,
        lastCpnCPI: float,
    ...
    def calcInflationAccruedInterest(self, settlementDate: FinDate, referenceCPI):
