...
def test_FinNumbaNumpySpeed(useSobol):
    ...
    callOption = FinEquityVanillaOption(expiryDate, 100.0, FinOptionTypes.EUROPEAN_CALL)
    ...
    for numPaths in numPathsList:
        ...
        start = time.time()
        valueMC = callOption.valueMC_NUMPY_ONLY(
            valueDate,
            stockPrice,
            discountCurve,
            dividendYield,
    ...
    for numPaths in numPathsList:
        ...
        start = time.time()
        valueMC = callOption.valueMC_NUMPY_NUMBA(
            valueDate,
            stockPrice,
            discountCurve,
            dividendYield,
    ...
    for numPaths in numPathsList:
        ...
        start = time.time()
        valueMC = callOption.valueMC_NUMBA_ONLY(
            valueDate,
            stockPrice,
            discountCurve,
            dividendYield,
