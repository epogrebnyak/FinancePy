...
def test_FinEquityVanillaOption():
    ...
    for stockPrice in stockPrices:
        ...
        rho = callOption.rho(valueDate, stockPrice, discountCurve, dividendCurve, model)
    ...
    for stockPrice in stockPrices:
        ...
        rho = putOption.rho(valueDate, stockPrice, discountCurve, dividendCurve, model)
        testCases.print(stockPrice, value, delta, vega, theta, rho)
        ...
        for timeToExpiry in timesToExpiry:
            ...
            for strike in strikes:
                ...
                for optionType in optionTypes:
                    ...
                    option = FinEquityVanillaOption(expiryDate, strike, optionType)
                    ...
                    if value - intrinsic > 1e-10:
                        ...
                        impliedVol = option.impliedVolatility(
                            valueDate, stockPrice, discountCurve, dividendCurve, value
                        )
